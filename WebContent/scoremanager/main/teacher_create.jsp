...
<c:import url="/common/base.jsp">
    ...
    <c:param name="content">
    	<h2 class="h2 mb-3 fw-norma bg-secondary bg-opacity-10 py-2 px-4" style="text-align: center;">教員情報登録</h2>
        <form action="TeacherCreateExecute.action" method="post">
        	<div class="col-4" style="width: 100%; margin-bottom: 10px;">
            	<label>教員コード</label>
                <input type="text" name="id" value="${not empty id ? id : ''}" placeholder="教員コードを入力してください" maxlength="15" required
            ...
            <div class="col-4" style="width: 100%; margin-bottom: 10px;">
            	<label>教員名</label>
                <input type="text" name="name" value="${not empty name ? name : ''}" placeholder="教員名を入力してください" maxlength="20" required
                	style="width: 100%; height: 40px; margin-bottom: 10px;
					border: 1px solid #ccc; border-radius: 5px;">
            </div>
            ...
            <div class="col-4" style="width: 100%; margin-bottom: 10px;">
            	<label>管理者権限</label>
                	<input class="form-check-input" type="checkbox" name="admin" value="t"
    >
            </div>
