	...
	<c:param name="content">
		...
		<form action="SubjectCreateExecute.action" method="post">
			<div class="col-4" style="width: 100%; margin-bottom: 10px;">
				<label>科目コード</label> <input type="text" name="cd"
					value="${not empty cd ? cd : ''}" placeholder="科目コードを入力してください"
			...
			<div class="col-4" style="width: 100%; margin-bottom: 10px;">
				<label>科目名</label> <input type="text" name="name"
					value="${not empty name ? name : ''}" placeholder="科目名を入力してください"
