            ...
            <form action="StudentCreateexecute.action" method="get">
                <div class="row border mx-3 mb-3 py-2 align-items-center rounded" id="filter">
					...
					<div class="col-3">
						...
						<select class="form-select" id="student-f2-select" name="f2" style="margin-bottom: 10px;">
=======
	<c:param name="content">
		<section class="me-4">
...
>>>>>>> branch 'master' of https://github.com/ml02100825/Scoremanager.git
					...
					<div class="col-3">
						...
						<select class="form-select" id="student-f3-select" name="f3" style="margin-bottom: 10px;">
							<option value="0">--------</option>
                    ...
                    <div class="col-2">
                        ...
                        <select class="form-select" id="student-f4-select" name="f4" style="margin-bottom: 10px;">
                            <option value="0">--------</option>
                            <c:forEach var="count" items="${count_num_set}">
